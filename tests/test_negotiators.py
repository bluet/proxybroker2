...
class TestNegotiatorContracts:
    ...
    def test_all_negotiators_exist(self):
        ...
        expected_protocols = ["SOCKS5", "SOCKS4", "CONNECT:80", "CONNECT:25", "HTTPS", "HTTP"]
        ...
        for protocol in expected_protocols:
            ...
            assert hasattr(negotiator_class, 'negotiate'), f"{protocol} negotiator missing negotiate method"
    ...
    def test_negotiators_have_required_attributes(self):
        ...
        for protocol, negotiator_class in NGTRS.items():
            ...
            assert hasattr(negotiator_class, 'name'), f"{protocol} missing name attribute"
            assert hasattr(negotiator_class, 'check_anon_lvl'), f"{protocol} missing check_anon_lvl"
            assert hasattr(negotiator_class, 'use_full_path'), f"{protocol} missing use_full_path"
